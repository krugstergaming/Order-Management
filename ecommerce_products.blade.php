        ...
        <header class="sidebar-header">
          ...
          <div class="sidebar-widget menu-widget">
            <div class="row text-center mbn">
              ...
              <div class="col-xs-4">
                <a href="pages_messages" class="text-info" data-toggle="tooltip" data-placement="top" title="Messages">
                  <span class="glyphicon glyphicon-inbox"></span>
                </a>
              </div>
              <div class="col-xs-4">
                <a href="pages_profile" class="text-alert" data-toggle="tooltip" data-placement="top" title="Tasks">
                  <span class="glyphicon glyphicon-bell"></span>
                </a>
              </div>
              <div class="col-xs-4">
                <a href="pages_timeline" class="text-system" data-toggle="tooltip" data-placement="top" title="Activity">
                  <span class="fa fa-desktop"></span>
                </a>
              </div>
              <div class="col-xs-4">
                <a href="pages_profile" class="text-danger" data-toggle="tooltip" data-placement="top" title="Settings">
                  <span class="fa fa-gears"></span>
                </a>
              </div>
              <div class="col-xs-4">
                <a href="pages_gallery" class="text-warning" data-toggle="tooltip" data-placement="top" title="Cron Jobs">
          ...
          <div class="sidebar-widget author-widget hidden">
            <div class="media">
              <a class="media-left" href="ecommerce_products#">
                <img src="assets/img/avatars/3.jpg" class="img-responsive">
              </a>
              <div class="media-body">
                <div class="media-links">
                   <a href="ecommerce_products#" class="sidebar-menu-toggle">User Menu -</a> <a href="pages_login(alt)">Logout</a>
                </div>
      ...
      <div id="topbar-dropmenu">
        <div class="topbar-menu row">
          <div class="col-xs-4 col-sm-2">
            <a href="ecommerce_products#" class="metro-tile">
