    ...
    <div class="panel">
      ...
      <div class="panel-body pn">
        <ul class="nav nav-list nav-list-sm pl15 pt10" role="tablist">
          <li class="active">
            <a href="{{url('ecommerce_customers')}}#toolbox-header" role="tab" data-toggle="tab">Navbar</a>
          </li>
          <li>
            <a href="{{url('ecommerce_customers')}}#toolbox-sidebar" role="tab" data-toggle="tab">Sidebar</a>
          </li>
          <li>
            <a href="{{url('ecommerce_customers')}}#toolbox-settings" role="tab" data-toggle="tab">Misc</a>
          </li>
        </ul>
        ...
        <div class="form-group mn br-t p15">
          <a href="{{url('ecommerce_customers')}}#" id="clearLocalStorage" class="btn btn-primary btn-block pb10 pt10">Clear LocalStorage</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="sidebar-left-content nano-content">
        ...
        <header class="sidebar-header">
          ...
          <div class="sidebar-widget author-widget hidden">
            <div class="media">
              <a class="media-left" href="{{url('ecommerce_customers')}}#">
                <img src="assets/img/avatars/3.jpg" class="img-responsive">
              </a>
              <div class="media-body">
                <div class="media-links">
                   <a href="{{url('ecommerce_customers')}}#" class="sidebar-menu-toggle">User Menu -</a> <a href="pages_login(alt).html">Logout</a>
                </div>
      ...
      <div id="topbar-dropmenu">
        <div class="topbar-menu row">
          <div class="col-xs-4 col-sm-2">
            <a href="{{url('ecommerce_customers')}}#" class="metro-tile">
