    ...
    <div class="panel">
      ...
      <div class="panel-body pn">
        <ul class="nav nav-list nav-list-sm pl15 pt10" role="tablist">
          <li class="active">
            <a href="ecommerce_settings.blade.php#toolbox-header" role="tab" data-toggle="tab">Navbar</a>
          </li>
          <li>
            <a href="ecommerce_settings.blade.php#toolbox-sidebar" role="tab" data-toggle="tab">Sidebar</a>
          </li>
          <li>
            <a href="ecommerce_settings.blade.php#toolbox-settings" role="tab" data-toggle="tab">Misc</a>
          </li>
        </ul>
        ...
        <div class="form-group mn br-t p15">
          <a href="ecommerce_settings.blade.php#" id="clearLocalStorage" class="btn btn-primary btn-block pb10 pt10">Clear LocalStorage</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <header id="topbar" class="ph10">
        <div class="topbar-left">
          <ul class="nav nav-list nav-list-topbar pull-left">
            ...
            <li class="active">
              <a href="{{url('ecommerce_customers')}}">Settings</a>
            </li>
          </ul>
        </div>
